...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "85b2c4e1-205d-422e-83d9-d1bb7880aca6");
    ...
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                ...
                <li><img src={phone_icon} alt="" />+94 775 634 667</li>
                <li><img src={location_icon} alt="" />13, Lion's club road, Kallady<br/> Batticaloa</li>
            </ul>
        </div>
        <div className="contact-col">
